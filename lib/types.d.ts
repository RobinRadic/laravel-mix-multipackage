import 'laravel-mix';
import { PackageJson as BasePackageJson } from 'types-package-json';
export declare namespace composer {
    ...
    type Repository = ComposerRepository | VcsRepository | PathRepository | ArtifactRepository | PearRepository | PackageRepository;
    interface Package {
        /**
        ...
        config?: {
            ...
            /**
             * The compatibility of the binaries, defaults to "auto" (automatically guessed), can be "full" (compatible with both Windows and Unix-based systems) and "symlink" (symlink also for WSL).
             */
            "bin-compat"?: "auto" | "full" | "symlink";
            /**
...
export interface ComposerJson extends composer.Package {
}
...
export interface MixEntry {
     ...
     */
    addFromOutput(val: any, output: object, fallback: object): this;
    /**
     ...
     * @param {Object} fallback
     */
    normalizePath(output: File, fallback: object): File;
}
